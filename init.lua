...
vim.diagnostic.config {
    update_in_insert = true, -- Keep showing diagnostics in Insert mode
    virtual_text = true, -- Show inline error messages
    signs = true, -- Keep signs in the gutter
    underline = true, -- Underline errors
}
vim.api.nvim_set_keymap('n', '<C-M-Right>', ':bnext<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<C-M-Left>', ':bprevious<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<C-w>', ':bd<CR>', { noremap = true, silent = true })
vim.opt.termguicolors = true
require('bufferline').setup {}

-- format when moving from insert to normal
...
-- move the cursor to the next line when its at the end of the line
vim.opt.whichwrap:append '<,>,h,l'

-- Enable Shift + Arrow key selection
